...
class OriginalContentsTokenTest extends TestCase
{
    /**
    ...
    private function token(string $originalContents = null): Token\OriginalContentsToken
    {
        $originalContents = new Token\OriginalContents(new Doubles\MockedFile($originalContents));
        return new Token\OriginalContentsToken($originalContents);
    }
}
