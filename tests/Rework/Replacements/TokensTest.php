...
class TokensTest extends TestCase
{
    public function testForValidTokens_CompositeTokenMethod_ReturnCompositeToken()
    {
        ...
        $tokens       = new Tokens(new Replacements($replacements), new Doubles\Rework\FakeReader());
    ...
    {
        return new Tokens(new Replacements($this->replacements($replacementValues)), new Doubles\Rework\FakeReader());
    }

    private function replacements(array $replacementValues): array
    {
        $create = fn (?string $value) => $value ? new Doubles\Rework\FakeReplacement($value) : null;
    ...
    {
        return $replacement->token($name, new Doubles\Rework\FakeReader());
    }
}
